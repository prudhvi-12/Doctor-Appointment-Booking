...
<div class="title"> 
     ...
     <a class="active" href="view-patient.php">View Patient</a>
...
<?php
      $conn = mysqli_connect("localhost", "root", "", "booking");
        $sql ="SELECT id,name,gmail,age,gender,address from patient";
            $res=mysqli_query($conn,$sql);
              ...
              {
                echo '<script>alert("No Patient Records")</script>';
              }
           mysqli_close($conn);
?>
