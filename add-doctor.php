...
<?php
      ...
      $conn = mysqli_connect("localhost", "root", "", "booking");
           if(isset($_POST['submit'])) {
             ...
             $dept=$_POST['dept'];
        $sql ="INSERT INTO doctor (name,gmail,address,dept,password,id) VALUES('$name','$gmail','$address','$dept','$password','$id')";
              if(!empty($name) && !empty($password) && !empty($gmail) && !empty($address) && !empty($dept) && mysqli_query($conn,$sql))
              {
